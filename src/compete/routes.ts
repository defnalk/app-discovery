...
<style>
  ...
  .icp-tag { display:inline-block; background:#10301f; color:var(--good); padding:2px 8px; border-radius:99px; font-size:11px; margin:0 4px 4px 0; }
  ...
  .histrow:hover { background:#1a2130; }
